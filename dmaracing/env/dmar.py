...
class DmarEnv():
    ...
    def compute_rewards(self,) -> None:
        ...
        rew_rank = 1.0/self.num_agents*(self.num_agents/2.0-self.ranks)*self.reward_scales['rank']
        ...
        self.reward_terms['rank'] += rew_rank
        self.reward_terms['collision'] += rew_collision
